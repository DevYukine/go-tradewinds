...
<template>
  <div class="bg-slate-800 rounded-lg shadow-lg border border-slate-700 p-5">
    ...
    <template v-else-if="world">
      ...
      <!-- Ports Tab -->
      <div v-if="activeTab === 'ports'" class="max-h-64 overflow-y-auto">
      ...
      <!-- Goods Tab -->
      <div v-if="activeTab === 'goods'" class="max-h-64 overflow-y-auto">
        <table class="w-full text-xs">
          <thead class="sticky top-0 bg-slate-800">
            <tr class="text-slate-500 border-b border-slate-700">
      ...
      <!-- Routes Tab -->
      <div v-if="activeTab === 'routes'" class="max-h-64 overflow-y-auto">
        <table class="w-full text-xs">
          <thead class="sticky top-0 bg-slate-800">
            <tr class="text-slate-500 border-b border-slate-700">
      ...
      <!-- Ship Types Tab -->
      <div v-if="activeTab === 'ships'" class="max-h-64 overflow-y-auto">
